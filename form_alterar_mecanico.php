...
if(!isset($_SESSION["system_control"]))
{
  ...
  <body>
    ...
    <div class="wrapper">
     ...
     ?>
      <div style=" margin-top: 60px;" class="container">         <center>         
        <div class="show-image" style="width: 100px;"> <img data-toggle="modal"
      data-target="#alterar_foto" src=<?php echo $vetor_login['imagem'];?>
