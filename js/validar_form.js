...
! function(a) {
    ...
    return function() {
        ...
        a.validator.addMethod("maxWords", function(a, c, d) {
            ...
            return this.optional(c) || b(a).match(/\b\w+\b/g).length >= d
        }, a.validator.format("Mínimo {0} caracteres.")), a.validator.addMethod("rangeWords", function(a, c, d) {
            var e = b(a),
                f = /\b\w+\b/g;
    ...
    }, a.validator.format("Mínimo {0} caracteres")), a.validator.addMethod("time", function(a, b) {
